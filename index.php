<?php
    ...
    $query="SELECT id_user, nama_user,role_user from user where username='$username'";
      ...
      <li class="dropdown user user-menu">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="user-footer">
            <div class="pull-left">
              <a href="?page=editpassword&aksi&id_user=<?php echo $data['id_user'];?>" class="btn btn-default btn-flat">Ganti Password</a>
            </div>
